...
from config import BASE_SIZE, BRANCH_NUM, CAPTIONS, END_TOKEN, CAP_MAX_LEN, MIN_WORD_FREQ, UNK_TOKEN
...
class Flowers:
    def __init__(self):
        ...
        with open('Flowers102/test/filenames.pickle', 'rb') as f:
            test = pickle.load(f)
        ...
        # with open('Flowers102/valclasses.txt', 'r', encoding='utf-8') as f:
            ...
            for line in test:
                ...
                s = 'image_'+str(name_id).zfill(5)

                #print(int(self.data['name'][name_id][-5:]),name_id)

                #self.data.loc[int(self.data['name'][name_id][-5:]), 'train'] = 0

                i=i+1;
                #print(self.data['name'])
                self.data.loc[self.data['name'] == s, 'train']= 0


               # print(self.data.loc[self.data['name']== s,'train'])
                ...
                # if(self.data['name'] == s):
                #     self.data.loc[self.data['name'],'train']=0
                #     print(s)

                #self.data.loc[self.data['name'][-5:] == name_id, 'train'] = 0

        #print(self.data[self.data.train == 0])
